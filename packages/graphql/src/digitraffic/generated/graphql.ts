...
export type TrainLocationFragment = { __typename?: 'TrainLocation', speed: number, accuracy: number | null, timestamp: string, location: Array<number>, train: { __typename?: 'Train', trainNumber: number, commuterLineid: string | null } | null };
...
export type LocationQuery = { __typename?: 'Query', latestTrainLocations: Array<{ __typename?: 'TrainLocation', speed: number, accuracy: number | null, timestamp: string, location: Array<number>, train: { __typename?: 'Train', trainNumber: number, commuterLineid: string | null } | null }> };
