...
export type RowFragment = { __typename?: 'TimeTableRow', commercialTrack: string | null, commercialStop: boolean | null, scheduledTime: string, type: TimeTableRowType, cancelled: boolean, liveEstimateTime: string | null, station: { __typename?: 'Station', shortCode: string, passengerTraffic: boolean } };
