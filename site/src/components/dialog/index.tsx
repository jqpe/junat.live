...
export function Dialog({
  ...
  return (
    <DialogPortal {...props}>
      <DialogOverlay className="backdrop-blur-sm z-[2] fixed inset-0 bg-[hsla(0,0%,100%,0.87)] -top-[var(--header-height)] grid items-center animate-[fadein_150ms_cubic-bezier(0.16,1,0.3,1)] dark:bg-[hsla(0,0%,0%,0.87)]" />
      <DialogContent
