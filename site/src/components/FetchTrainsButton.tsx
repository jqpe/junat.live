    ...
    >
      <defs>
        <linearGradient
          ...
          id="ffflux-gradient"
        >
          <stop stopColor="#420071" stopOpacity="1" offset="0%"></stop>
          <stop stopColor="#030304" stopOpacity="1" offset="100%"></stop>
        </linearGradient>
        <filter
          id="ffflux-filter"
          x="-20%"
    ...
    >
      <defs>
        <linearGradient
          ...
          id="gradient"
        >
          <stop stopColor="#f6eaff" stopOpacity="1" offset="0%"></stop>
          <stop stopColor="#fbfbfb" stopOpacity="1" offset="100%"></stop>
        </linearGradient>
        <filter
          id="filter"
          x="-20%"
