...
export const Spinner = ({ fixedToCenter, ...props }: SpinnerProps) => {
  ...
  return (
    <div
      ...
      rounded-full [-webkit-mask-composite:source-out] [-webkit-mask:conic-gradient(#0000_10%,#000),_linear-gradient(#000_0_0)_content-box] supports-[mask-composite:subtract]:[mask-composite:subtract]`}
    />
  )
}
