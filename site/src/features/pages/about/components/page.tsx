...
export const AboutUsPage = () => {
  ...
  return (
    <>
      <Head
        path="/about"
        description="About Junat.live, the free train schedule site for Finnish train traffic."
        title="About Us"
      />
      <main className="flex flex-col max-w-[500px] m-auto p-2 mt-5">
        <div className="mx-5 mb-2">
          <h1>About Us</h1>
          <p className="mt-2">
            Junat.live was built as an alternative for proprietary train
            schedule websites. Our values are privacy, reliability, and
            accessibility. Junat.live is open-source software.
          </p>
        ...
        <Section id="filtering">
          ...
          <p>
            Filter trains on the station page by destination. The feature is
            smart enough to also include trains that stop at that station, even
            if it&apos;s not the final destination.
          </p>
